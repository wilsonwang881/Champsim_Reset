...
void oracle_recorder::prefetcher::duplicate_check(std::deque<reset_misc::access> &non_uniq_dq, std::set<uint64_t> &check_set, uint64_t limit)
{
...
void oracle_recorder::prefetcher::record_non_uniq(uint64_t addr, std::deque<reset_misc::access> &non_uniq_dq, std::set<uint64_t> &duplicate_set, uint64_t current_cycle, uint64_t limit)
{
...
void oracle_recorder::prefetcher::write_to_file(std::string file_name, std::deque<reset_misc::access> dq, std::string seperator)
{
  std::ofstream file;
